import { ALL_TYPES, FILTER_APIDB, FILTER_TYPES, GET_DETAIL_POKEMON, GET_POKEMONS, ORDER_POKEMON_ATTACK, SEARCH_POKEMON, SORT_POKEMONS_ASC_DESC } from "./actions";
    ...
    switch(action.type) {
        ...
        case SEARCH_POKEMON:
          ...
          case FILTER_TYPES:
            ...
            action.payload === "all"
              ? pokemonCopy
              : pokemonCopy.filter((pokemon) => pokemon.types.includes(action.payload));
              return{
                ...state,
